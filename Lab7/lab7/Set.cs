...
namespace lab7
{
    public class Set
    {
        ...
        public static implicit operator string(Set A)
        {
            int size = A.set.Length;
            char[] tmp = new char[size];
            //string tmp
            for (int i = 0; i < A.set.Length; i++)
            {
            ...
            string value = String.Concat<char>(tmp);
            return value;
        }


        public static explicit operator Set(string str)
        {

            str.ToCharArray();
            Set A = new Set(str.Length);
            for (int i = 0; i < str.Length; i++)
            {
                A.set[i] = str.ToCharArray()[i];
            }

            return A;
        }

        public static bool operator true(Set A)
        {
            if (A.set.Length != 0) return true;
            return false;
        }
        public static bool operator false(Set A)
        {
            if (A.set.Length == 0) return true;
            return false;
        }

        public string unification(Set A, Set B)
        {
            string tmp = A + B;
            return tmp;
        }

        public string intersection(Set A, Set B)
        {
            string tmp = A * B;
            return tmp;
        }

        public string without(Set A, Set B)
        {
            string tmp = A - B;
            return tmp;
        }
